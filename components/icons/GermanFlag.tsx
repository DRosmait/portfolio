...
const GermanFlag = (props: Props) => {
  return (
    ...
    >
      ...
      <path
        style={{ fill: "#FFE000" }}
        d="M7.286,395.901c0,60.095,48.717,108.812,108.812,108.812h279.803
c60.095,0,108.812-48.717,108.812-108.812v-56.997H7.286V395.901z"
      />
      <path
        style={{ fill: "#333333" }}
        d="M395.901,7.286H116.099C56.003,7.286,7.286,56.003,7.286,116.099v56.997h497.427v-56.997
C504.714,56.003,455.997,7.286,395.901,7.286z"
      />
      <path
        d="M395.901,0H116.099C52.082,0,0,52.082,0,116.099v279.803C0,459.918,52.082,512,116.099,512h279.803
